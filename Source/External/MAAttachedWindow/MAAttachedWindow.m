...
- (void)_updateGeometry
{
    ...
    contentRect.origin = (_window) ? [_window convertRectToScreen: NSMakeRect(_point.x, _point.y, 0, 0)].origin : _point;
...
- (MAWindowPosition)_bestSideForAutomaticPosition
{
    ...
    NSPoint pointOnScreen = (_window) ? [_window convertRectToScreen: NSMakeRect(_point.x, _point.y, 0, 0)].origin : _point;
